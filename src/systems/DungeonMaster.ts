...
import { advanceTime, addAlert, removeAlert, gameTick, handleAsteroidImpacts } from '../store/shipStore';
...
export class DungeonMaster {
	...
	private gameLoop() {
		...
		if (weaponsState && weaponsState.asteroids) {
			store.dispatch(handleAsteroidImpacts({ asteroids: weaponsState.asteroids }));
		}
