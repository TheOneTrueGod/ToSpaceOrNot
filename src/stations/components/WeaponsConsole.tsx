...
export const WeaponsConsole: React.FC = () => {
	...
	// Get engineering alerts for this component (Weapons and Power systems)
	...
	return (
		<div className="w-full">
			...
			<div className="mt-2 px-8 max-w-[500px] ml-auto mr-auto">
				<div className="flex items-center gap-2 mb-1 flex-row">
					<span className="text-gray-400 text-sm font-mono">Battery </span>
					...
					return (
						<div key={btn.label} className="flex flex-col items-center">
							<button
								...
								className={`px-4 py-2 rounded font-mono text-white relative overflow-hidden transition-all ${disabled ? 'opacity-60 cursor-not-allowed' : 'hover:brightness-110'
									}`}
